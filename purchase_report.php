		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Purchase reports</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title">Table of Purchase</h4>
                                <p class="category">These are the information of purchase made to the system</p>
                            </div>
