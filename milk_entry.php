                                ...
                                <ul class="nav navbar-nav navbar-left">
                                    <li>
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            ...
                                            <p class="hidden-lg hidden-md">Milk Entry</p>
                                        </a>
                                    </li>
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="magret">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Quantity of Milk produced (kg)</label>
                    ...
                    <div class="col-md-2">
                    <img class="img-rounded" src="img/alminium.jpg">
                    </div>
                    <div class="col-md-2">
                        <img class="img-rounded" src="img/alminium.jpg">
                    </div>
