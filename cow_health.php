                    ...
                    <nav class="navbar navbar-default navbar-fixed">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="#">NEW DELIVERY</a>
                            </div>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="content">
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Disease</label>
                                            <input type="text" class="form-control" placeholder="common cold">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="header">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Vacine Name</label>
                ...
                <div class="col-md-4">
                    <img class="img-rounded img-responsive" src="img/chicken.jpg">
                </div>
